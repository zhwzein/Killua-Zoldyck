    ...
    exec: async(killua, m, { args }) => {
        ...
        if (!b) {
            ...
            switch(b.toLowerCase()) {
                ...
                break
                case "skype":
                    killua.sendFile(m.from, fetch.result.skype, "", m, { asSticker: true, author: global.author, packname: global.packname, categories: ['😄','😊'] })
                break
                case "joypixels":
                    killua.sendFile(m.from, fetch.result.joypixels, "", m, { asSticker: true, author: global.author, packname: global.packname, categories: ['😄','😊'] })
                break
                case "openmoji":
                    killua.sendFile(m.from, fetch.result.openmoji, "", m, { asSticker: true, author: global.author, packname: global.packname, categories: ['😄','😊'] })
                break
                case "emojidex":
                    killua.sendFile(m.from, fetch.result.emojidex, "", m, { asSticker: true, author: global.author, packname: global.packname, categories: ['😄','😊'] })
                break
                case "notoemoji":
                    killua.sendFile(m.from, fetch.result.noto_emoji, "", m, { asSticker: true, author: global.author, packname: global.packname, categories: ['😄','😊'] })
                break
                case "messenger":
                    killua.sendFile(m.from, fetch.result.messenger, "", m, { asSticker: true, author: global.author, packname: global.packname, categories: ['😄','😊'] })
                break
                case "lg":
