...
async function imageToWebp (media) {
    ...
    const tmpFileOut = path.join(__dirname, `../database/${Crypto.randomBytes(6).readUIntLE(0, 6).toString(36)}.webp`)
    const tmpFileIn = path.join(__dirname, `../database/${Crypto.randomBytes(6).readUIntLE(0, 6).toString(36)}.jpg`)
